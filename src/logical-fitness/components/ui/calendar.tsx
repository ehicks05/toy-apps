// SOURCE: https://github.com/flixlix/shadcn-date-picker
// DOCS: https://date-picker.luca-felix.com/
	...
	const isPreviousDisabled = (() => {
		if (navView === 'years') {
			return (
				...
				(endMonth &&
					differenceInCalendarDays(new Date(displayYears.from - 1, 0, 1), endMonth) >
						0)
			);
		}
			...
			return (
				(startMonth &&
					differenceInCalendarDays(new Date(displayYears.to + 1, 0, 1), startMonth) <
						0) ||
				(endMonth &&
					differenceInCalendarDays(new Date(displayYears.to + 1, 0, 1), endMonth) >
						0)
			);
		}
		return !nextMonth;
