...
export const Demo = () => {
	...
	const [readOnlyPK, setReadOnlyPK] = useState(
	...
	return (
		<div className="m-auto flex max-w-screen-xl flex-col gap-4">
			<div className="flex flex-wrap gap-2">
				...
				<input
					className="rounded px-6 h-12 w-full bg-[#512da8] font-semibold"
					disabled={!!walletPK}
					value={readOnlyPK}
			...
			<div className="bg-sky-800 p-4 font-bold">PK: {publicKey?.toBase58()}</div>
